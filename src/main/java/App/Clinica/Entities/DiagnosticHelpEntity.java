...
public class DiagnosticHelpEntity {
    ...
    private DiagnosticOrderEntity diagnosticOrder;
    ...
    public DiagnosticHelpEntity() {}

    public DiagnosticHelpEntity(DiagnosticOrderEntity diagnosticOrder, int amount, double cost, 
                              boolean requiresSpecialist, String typeSpecialty, String specialistId, int itemNumber) {
        validateFields(amount, cost, requiresSpecialist, typeSpecialty, specialistId);
    ...
    private void validateFields(int amount, double cost, boolean requiresSpecialist, 
                              String typeSpecialty, String specialistId) {
        if (amount <= 0) {
    ...
    public DiagnosticOrderEntity getDiagnosticOrder() {
        return diagnosticOrder;
    }

    public void setDiagnosticOrder(DiagnosticOrderEntity diagnosticOrder) {
        this.diagnosticOrder = diagnosticOrder;
    }
